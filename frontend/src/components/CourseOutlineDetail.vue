		...
		>
			...
			>
				...
				>
					...
					/>
					<div
						class="text-base text-left leading-5 ml-2"
				...
				<DisclosurePanel v-if="!chapter.is_scorm_package">
					...
					>
						<template #item="{ element: lesson }">
							<div
								class="outline-lesson pl-8 pr-4 text-ink-gray-9"
								:class="
							...
							>
								...
								>
									<div
										class="flex items-center text-sm leading-5 group text-[#001931] lesson-title-hover"
										style="
											font-size: 14px;
											font-style: normal;
											font-weight: 700;
...
.outline-lesson:hover {
  transition: all 0.3s;
  background: rgba(227, 77, 0, 0.05);
}

.outline-lesson:hover .lesson-text,
.outline-lesson:hover .lesson-name {
  color: rgba(227, 77, 0, 1) !important;
